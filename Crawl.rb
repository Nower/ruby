...
#一定要注意正则表达式的/，不小心就出问题了
#ruby Crawl.rb 2 1000 http://www-cs.standford.edu/People
#regexp
$link_regexp = /href\=\"[^\"]*\"/
...
if ARGV==nil || ARGV.length<3
    puts '-- Command --'
    puts 'ruby Crawl.rb 2 1000 http://www-cs.standford.edu/People'
    puts 'help: 2->max_depth, 1000->max_pages, http://www-cs.standford.edu/People->url'
    exit(0)
end
